# C3-B1 numeric threshold proposal rationale — round 1
...
`testdata/decoders/cycle3/threshold-proposal-round-1.json`.
...
acceptance `7baa53b`, and proposal assignment `29ac784`. Its five raw-file
digests and experiment-cap digest are literal machine-checkable inputs.
...
| Successful parent total | 1 s | 105,815,301 ns | rounded ceiling above raw × 8 |
